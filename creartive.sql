...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 15, 2024 at 06:27 AM
...
INSERT INTO `user` (`user_id`, `username`, `email`, `password`, `profile_picture`, `bio`, `created_at`) VALUES
(1, 'creartive', 'admin@gmail.com', 'admin123', NULL, NULL, '2024-12-15 09:46:04');
...
--
ALTER TABLE `images`
  ADD CONSTRAINT `images_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE;
